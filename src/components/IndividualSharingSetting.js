...
export const IndividualSharingSetting = () => {
                                ...
                                return (
                                    <TableRow key={option.id + "_" + keyCount}>
                                        ...
                                        <TableCell style={styles.columnForEditButton}>
                                            <SpecialButton id={option.id} color={styles.iconColor} callBackHandleClick={HandleClickButton} type={"USERDATA"} enabled={props.resource.sharingData} defaultValue={AccessData} title={i18n.t("Not available for this type of object")} />
                                        </TableCell>
                                        <TableCell style={styles.columnForEditButton}>
                                            <Button
                            ...
                            sharingOption.userGroupAccesses.map((option) => {
                                ...
                                return (
                                    <TableRow key={option.id + "_" + keyCount}>
                                        ...
                                        <TableCell style={styles.columnForEditButton}>
                                            <SpecialButton id={option.id} color={styles.iconColor} callBackHandleClick={HandleClickButton} type={"GROUPDATA"} enabled={props.resource.sharingData} defaultValue={AccessData} title={i18n.t("Not available for this type of object")} />
                                        </TableCell>
                                        <TableCell style={styles.columnForEditButton}>
                                            <Button
                                                onClick={() => handleRemoveItem(option.id)}
